			...
			<div className='app__header-wrapper'>
				<header className='app__header'>
					<div className='app__header-input-wrapper'>
						<input className='app__header-input' placeholder='Search here' onKeyUp={this.handleOnKeyUp} />

						<svg className='svg-icon' fill='#000000' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' width='24px' height='24px'>
