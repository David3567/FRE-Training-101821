						...
						<div class='responsive-summary'>
							...
							<div class='col-sm-4 col-md-4'>
								<div class='responsive-description'>
									...
									<p>
										Development and design isn't merely putting information on the site or preferred media outlet. I organize content and present information in an engaging
										fashion, driving new and unique layouts in tandem with novel solutions and cool animations.
									</p>
								</div>
							</div>
						</div>
						...
						<div class='ideas-summary'>
							...
							<div class='col-sm-4 col-md-4'>
								<div class='idea-description'>
									...
									<p>
										There are still many problems that exist in today's society, including laziness. Luckily, I hope to combat these issues by innovating, developing easy-to-use
					...
					<div class='row'>
						<div class='col-sm-6 col-md-6'>
							<div class='contact-instructions'>
								...
								<p>
									Don't be afraid to contact me! I'm happy to answer any questions, provide more information, or just have a nice conversation! Fill out the form below to being
									reaching out to me. If you prefer another email client other than your default, which will appear after clicking the button and have all of the information you just
